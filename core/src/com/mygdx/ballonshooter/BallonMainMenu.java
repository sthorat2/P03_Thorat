...
public class BallonMainMenu extends BaseScreen {
    ...
    public BallonMainMenu(Game game) {
        super(game);
    }
    ...
    protected void init() {
        ...
        title = ActionManager.createActor(mainStage,"logo.png",viewWidth/2,viewHeight/2);
